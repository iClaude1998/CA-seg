...
class Bkaiattributes_seg(Dataset):
    r"""
    ...
    def __getitem__(self, index) -> Dict[str, Any]:
        ...
        if prompt is None:
            ...
            prompt['number'] = "A"
        # skin melanoma
        input_prompts = [f"{prompt['number']} polyp",
                         f"{prompt['shape']} polyp", 
                         f"{prompt['color']} polyp", 
                         f"{prompt['size']} polyp", 
                         f"{prompt['number']} polyp on the {prompt['location']}",
                         f"{prompt['number']} {prompt['color']}, polyp",
                         f"{prompt['number']} {prompt['shape']}, polyp",
                         f"{prompt['number']} {prompt['size']}, polyp",
                         f"{prompt['number']} polyp locate on the {prompt['location']}",
                         "a picture of colon polyp",
                         f"{prompt['shape']} colon polyp", 
                         f"{prompt['color']} colon polyp", 
                         f"{prompt['size']} colon polyp", 
                         f"colon polyp on the {prompt['location']}",
                         ]
