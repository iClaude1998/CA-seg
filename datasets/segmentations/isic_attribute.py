...
class ISICattribute_seg(Dataset):
    r"""
    ...
    def __getitem__(self, index) -> Dict[str, Any]:
        ...
        # skin melanoma
        input_prompts = [f"{prompt['shape']} skin melanoma", 
                         f"{prompt['color']} skin melanoma", 
                         f"{prompt['size']} skin melanoma", 
                         f"skin melanoma on the {prompt['location']}",
                         f"A {prompt['size']}, {prompt['color']}, {prompt['shape']} skin melanoma locate on the {prompt['location']}",
                         f"A {prompt['size']}, {prompt['shape']}, {prompt['color']} skin melanoma locate on the {prompt['location']}",
                         f"A {prompt['size']}, {prompt['color']}, skin melanoma",
                         f"A {prompt['shape']}, {prompt['color']}, skin melanoma",
                         "a picture of skin melanoma",
                         f"{prompt['shape']} skin lesion", 
                         f"{prompt['color']} skin lesion", 
                         f"{prompt['size']} skin lesion", 
                         f"skin lesion on the {prompt['location']}",
                         f"A {prompt['size']}, {prompt['color']}, {prompt['shape']} skin lesion locate on the {prompt['location']}",
                         ]
