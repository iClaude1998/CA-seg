...
from .utils import InitWeights_He, sigmoid_helper
from .nn_block import conv_nd, FFParser
from .segmentation_network import SegmentationNetwork
from .nn_block import ConvDropoutNormNonlin, StackedConvLayers



class Generic_UNet_v1(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
                 ...
                 nonlin=nn.LeakyReLU, nonlin_kwargs=None, deep_supervision=False, anchor_out=False,
                 final_nonlin=sigmoid_helper, weightInitializer=InitWeights_He(1e-2), pool_op_kernel_sizes=None,
                 conv_kernel_sizes=None,
                 upscale_logits=False, convolutional_pooling=False, convolutional_upsampling=False,
                 max_num_features=None, basic_block=ConvDropoutNormNonlin, image_size=256):
        """
        ...
        """
        super(Generic_UNet_v1, self).__init__()
        ...
        for d in range(num_pool):
            ...
            if d != num_pool - 1:
                ...
                self.ffparser.append(FFParser(output_features, image_size // (2 **(d+1)), image_size // (2 **(d+2))+1))
    ...
    def forward(self, x, hs = None):
        ...
        return conv_nd(2, x.size(1), 512, 1).to(device = x.device)(x)
