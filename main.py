...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='configs/cbm_bioparse/radiography_right+lung_s.yaml', help='path to config file')
    parser.add_argument('--num_workers', type=int, default=0, help='number of workers for dataloader')
    parser.add_argument('--exp_name', type=str, default='radiography_right+lung_s', help='the name of the experiment')
    parser.add_argument('--device', type=str, default='cuda', help='experiment device')
<<<<<<< HEAD
    parser.add_argument('--learn_obj', type=str, default='dice', choices=['recflow', 'ddpm', 'ddpmpp', 'recflowturb', 'cbm', 'dice'], help='the learning objective')
=======
    parser.add_argument('--learn_obj', type=str, default='cbm', choices=['recflow', 'ddpm', 'ddpmpp', 'recflowturb', 'cbm', 'dice', 'cbm_weakly'], help='the learning objective')
>>>>>>> 6f8298d37de269cabdcf725a53567b23080a4074
...
if __name__ == '__main__':
    ...
    if cfgs.learn_obj != 'cbm' and cfgs.learn_obj != 'cbm_weakly':
