...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='configs/cbm_bioparse/radiography_left+lung.yaml', help='path to config file')
    parser.add_argument('--num_workers', type=int, default=0, help='number of workers for dataloader')
    parser.add_argument('--exp_name', type=str, default='left_lung', help='the name of the experiment')
