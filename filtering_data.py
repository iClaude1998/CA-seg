...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='configs/cbm_bioparse/radiography_right+lung_biomedclip.yaml', help='path to config file')
    parser.add_argument('--num_workers', type=int, default=0, help='number of workers for dataloader')
    parser.add_argument('--exp_name', type=str, default='radiography_right+lung_biomedclip.yaml', help='the name of the experiment')
...
if __name__ == '__main__':
    ...
    if task == 0:
        ...
        exps = ["radiography_right+lung_biomedclip", "radiography_left+lung_biomedclip"]
